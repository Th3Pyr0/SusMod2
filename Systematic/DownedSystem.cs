...
namespace OldShit.Systematic
{
	...
	{
		public static bool downedSolaris = false;
		...
		public override void LoadWorldData(TagCompound tag) {
			downedSolaris = tag.ContainsKey("downedMinionBoss");
