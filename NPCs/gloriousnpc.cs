...
namespace OldShit.NPCs
{
	public class SussyNPC: GlobalNPC
	{
		...
		public override void SetupShop(int type, Chest shop, ref int nextSlot) {
			if (Main.LocalPlayer.talkNPC == -1 || !Main.npc[Main.LocalPlayer.talkNPC].GetGlobalNPC<SussyNPC>().HasBeenHitByPlayer) {
				return;
			}
