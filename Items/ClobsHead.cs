...
namespace OldShit.Items.Projectiles
{
	...
	public class ClobbedHead : ModProjectile
	{

		public override void SetStaticDefaults() {
			DisplayName.SetDefault("ClobbedHead");
		}
		...
		public override void Kill(int timeLeft) {
			...
			for (int i = 0; i < 4; i++) {
				...
				Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity, ProjectileID.	InfernoHostileBlast, Projectile.damage / 2, Projectile.knockBack, Projectile.owner);
			}
		}
		...
		public override bool OnTileCollide(Vector2 oldVelocity) {
			...
			SoundEngine.PlaySound(Main.rand.NextBool() ? SoundID.Roar : SoundID.Item8, Projectile.position);
